...
namespace Client.Models
{
    public class Profile : ViewModelBase
    {
        ...
        public async static Task Save(string name, Window window)
        {
            try
            {
        ...
        public async static Task SaveAs(string name, Window window)
        {
            JObject profile = new JObject
            {
                { "Name", name },
        ...
        public async static Task Load(string name, Window window)
        {
            try
            {
                string[] files = Directory.GetFiles(LoadFile.LoadFolder("Resources/Profiles"));
        ...
        {
            JObject? profile = GetProfileByName(Name);
